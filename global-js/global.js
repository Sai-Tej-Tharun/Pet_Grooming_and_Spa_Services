...
function initBookingModal() {
  ...
  modal.innerHTML = `
    <div class="modal-header" style="position:relative;justify-content:center">
      <h4 id="booking-modal-title" style="font-family:var(--font-heading);font-weight:600;color:var(--text-heading);text-align:center">
        🐾 Book an Appointment
      </h4>
      <button class="modal-close" aria-label="Close booking modal" data-modal-close="booking-modal" style="position:absolute;right:0;top:50%;transform:translateY(-50%)">
